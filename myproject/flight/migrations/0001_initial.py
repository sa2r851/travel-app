...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.IntegerField(default=0, verbose_name='سعر التذكرة')),
                ('ourdata', models.DateField(default=datetime.date.today, verbose_name='معاد الرحلة')),
                ('lunchtime', models.TimeField(blank=True, null=True, verbose_name='وقت الاقلاع')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flight.flightcompony')),
                ('destination', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='to_where', to='flight.city')),
                ('fromwhere', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='from_where', to='flight.city')),
            ],
        ),
    ]
