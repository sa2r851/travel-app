    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='umrah', to='umrah.umrahcompony')),
            ],
        ),
        migrations.CreateModel(
            name='hegg',
            fields=[
                ...
                ('durtion', models.IntegerField(default=0, verbose_name='عدد الايام')),
                ('ourdata', models.DateField(default=datetime.date.today, verbose_name='معاد الرحلة')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hegg', to='umrah.umrahcompony')),
            ],
        ),
    ]
