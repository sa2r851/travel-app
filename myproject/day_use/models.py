...
class dayusecompony(models.Model):
...
class city(models.Model):
    ...
    city_image=models.ImageField(upload_to="dayuse/cities", height_field=None, width_field=None)
    def __str__(self):
        return self.city_name
class daytrip(models.Model):
    company=models.ForeignKey(dayusecompony,on_delete=models.CASCADE)
    ...
    trip_images=models.ImageField(upload_to="dayuse/trips", height_field=None, width_field=None, max_length=100)
    def __str__(self):
