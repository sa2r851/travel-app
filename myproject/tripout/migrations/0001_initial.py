    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country_name', models.CharField(max_length=20, verbose_name='اسماء الدول')),
                ('country_image', models.ImageField(upload_to='tripout/cities')),
            ],
        ),
        migrations.CreateModel(
            name='tripoutcompony',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip_images', models.ImageField(upload_to='tripout/trips')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tripout.tripoutcompony')),
                ('destination', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='to_where', to='tripout.country')),
            ],
        ),
    ]
