    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_image', models.ImageField(upload_to='tripin/cities')),
            ],
        ),
        migrations.CreateModel(
            name='tripincompony',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip_images', models.ImageField(upload_to='tripin/trips')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tripin.tripincompony')),
                ('destination', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='to_where', to='tripin.city')),
                ('fromwhere', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='from_where', to='tripin.city')),
            ],
        ),
    ]
